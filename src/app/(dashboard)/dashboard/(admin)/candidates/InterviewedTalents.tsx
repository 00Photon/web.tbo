  ...
  useEffect(() => {
    const fetchApplications = async () => {
      try {
        ...
        // Filter for INTERVIEWED status
        const interviewedApplications = data
        ...
        setApplications(interviewedApplications);
        setAnchorEl(Array(interviewedApplications.length).fill(null));
      } catch (err) {
  ...
  return (
    ...
    >
      <CardContent sx={{ p: (theme) => theme.spacing(3) }}>
        {!smallScreen && <Typography variant="h6">Interviewed Talents</Typography>}
...
export default InterviewedTalents;
